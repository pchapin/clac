...
namespace {
    ...
    bool floating_mantissa(const char*&);
    bool floating_number(const char*&);
    bool digit_list(const char*&);
    bool integer_mantissa(const char*&);
    bool exponent(const char*&);

    bool complex_number(const char*&);
    bool number(const char*&);
    bool white(const char*&);
